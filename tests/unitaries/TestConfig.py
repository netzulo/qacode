...
# TODO: Replace literal strings with constants where it makes sense
class TestConfig(TestInfoBase):
    '''
    Comprueba el fichero que se pasa por parametro a Nose, si contiene un JSON
    con la estructura pedida en los tests
    '''
    ...
    def test_004_config_has_key_bot_url_hub(self):
        ...
        self.assertRegexpMatches(
            cfg.get("BOT")["url_hub"], self.regexs[0],
    ...
    def test_005_config_has_key_bot_url_node(self):
        ...
        self.assertRegexpMatches(
            cfg.get("BOT")["url_node"], self.regexs[0],
    ...
    def test_013_config_has_key_test_functionals_url_login(self):
        ...
        self.assertRegexpMatches(
            cfg.get("TEST_FUNCTIONALS")["url_login"],
    ...
    def test_014_config_has_key_test_functionals_url_logout(self):
        ...
        self.assertRegexpMatches(
            cfg.get("TEST_FUNCTIONALS")["url_logout"],
    ...
    def test_015_config_has_key_test_functionals_url_logged_ok(self):
        ...
        self.assertRegexpMatches(
            cfg.get("TEST_FUNCTIONALS")["url_logged_ok"],
    ...
    def test_016_config_has_key_test_functionals_url_logged_ko(self):
        ...
        self.assertRegexpMatches(
            cfg.get("TEST_FUNCTIONALS")["url_logged_ko"],
    ...
    def test_017_config_has_key_test_functionals_selectors_login(self):
        ...
        values = ast.literal_eval(
            cfg.get("TEST_FUNCTIONALS")["selectors_login"]
        )
